...
function prenota(j) {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          window.location.href = "http://localhost/Progetto2021/libri_prenotati.php?dbTitolo=" + dbTitolo + "&dbAutore=" + dbAutore + "&dbISBN=" + dbISBN + "&dbCategoria=" + dbCategoria + "&dbPagine=" + dbPagine;
